    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-md p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-6 relative z-10">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-100 tracking-tight">Create Enterprise Security Tenant</h1>
          <p className="text-xs text-slate-400">Deploy TrustGuard AI Firewall Guardrails</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-slate-300 uppercase tracking-wider block">Organization Name</label>
